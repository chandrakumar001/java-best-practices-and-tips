...
import com.example.ecom.JavaBestPracticesAndTips;
...
@SpringBootTest(
        classes = JavaBestPracticesAndTips.class,
...
//
//        final Results results = Runner.path("classpath:feature/usertracking/read")
//                .tags(TAG_IGNORE)
//                .parallel(100);
//        generateReport(results.getReportDir());
//        assertEquals(0, results.getFailCount(), results.getErrorMessages());
//    }
    ...
    void testParallelRead() {
        ...
        final Results results = Runner.path("classpath:feature/usertracking/test")
                .tags(TAG_IGNORE)
                .parallel(100);
        generateReport(results.getReportDir());
        assertEquals(0, results.getFailCount(), results.getErrorMessages());
